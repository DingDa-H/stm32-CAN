...
{
	{.ulID    = 0x1158666F,.ucDLC   = 4,.pucData = s_Txdata,.ulIDE   = CAN_ID_EXT,.ulRTR   = CAN_RTR_DATA,},
	{.ulID    = 0x1258666F,.ucDLC   = 4,.pucData = s_Txdata,.ulIDE   = CAN_ID_EXT,.ulRTR   = CAN_RTR_DATA,},
	{.ulID    = 0x55F,	   .ucDLC   = 4,.pucData = s_Txdata,.ulIDE   = CAN_ID_STD,.ulRTR   = CAN_RTR_DATA,},
	{.ulID    = 0x666,	   .ucDLC   = 4,.pucData = s_Txdata,.ulIDE   = CAN_ID_STD,.ulRTR   = CAN_RTR_DATA,},
	{.ulID    = 0x1358666F,.ucDLC   = 4,.pucData = s_Txdata,.ulIDE   = CAN_ID_EXT,.ulRTR   = CAN_RTR_REMOTE,},
	{.ulID    = 0x666,	   .ucDLC   = 4,.pucData = s_Txdata,.ulIDE   = CAN_ID_STD,.ulRTR   = CAN_RTR_REMOTE,},
};
...
void vtask(void)
{
	...
	vOledWriteStringToBuffer(6,12,(uint8_t*)"RXID:",emOledFontSize_6x12,emOledPixelShowMode_Positive,OLED);
